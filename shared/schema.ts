...
export const connectionTopics = pgTable("connection_topics", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
export const insertConnectionTopicSchema = createInsertSchema(connectionTopics).omit({
  id: true,
});

export type ConnectionTopic = typeof connectionTopics.$inferSelect;
export type InsertConnectionTopic = z.infer<typeof insertConnectionTopicSchema>;

export const connectionQuestions = pgTable("connection_questions", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
export type ConnectionQuestion = typeof connectionQuestions.$inferSelect;
export type InsertConnectionQuestion = z.infer<typeof insertConnectionQuestionSchema>;

export const connectionResponses = pgTable("connection_responses", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull(),
...
export const insertConnectionResponseSchema = createInsertSchema(connectionResponses).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export type ConnectionResponse = typeof connectionResponses.$inferSelect;
export type InsertConnectionResponse = z.infer<typeof insertConnectionResponseSchema>;

export const connectionSummaries = pgTable("connection_summaries", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull(),
  topicId: varchar("topic_id").notNull(),
  summary: text("summary").notNull(),
...
export const insertConnectionSummarySchema = createInsertSchema(connectionSummaries).omit({
  id: true,
  createdAt: true,
});

export type ConnectionSummary = typeof connectionSummaries.$inferSelect;
export type InsertConnectionSummary = z.infer<typeof insertConnectionSummarySchema>;
